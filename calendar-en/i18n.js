...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      modeLabel: '処理モード：',
      modeHybrid: '通常（正規表現＋必要時AI）',
      modeAi: '最初からAI（全項目をAIで取得）',
      msgError: 'エラー: ',
    ...
    en: {
      ...
      modeLabel: 'Mode: ',
      modeHybrid: 'Normal (regex + AI when needed)',
      modeAi: 'AI from the start (extract all fields with AI)',
      msgError: 'Error: ',
    ...
    "in": {
      ...
      modeLabel: 'Mode: ',
      modeHybrid: 'Normal (regex + zaroorat par AI)',
      modeAi: 'Shuru se AI (sabhi fields AI se nikaalein)',
