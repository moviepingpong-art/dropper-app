...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      attendBtn: '🙋 出欠を作る',
      attendSetupBtn: '🙋 出欠の回答フォームを付ける',
      attendDone: '✓ 出欠を作りました',
      attendCreating: '出欠を作っています…',
      attendCreated: '案内文に出欠リンクを入れました',
      attendExisting: 'すでに作られていた出欠を使います',
      attendNoName: '{ev}名が空です。先に{ev}名を入れてください。',
      attendNoEvents: '種目を読み取れませんでした。競技方法欄に種目（例：男女ダブルス 等）を入れてください。',
      attendSettings: '出欠システムの設定',
      attendChecking: '確かめています…',
      attendOk: '✓ つながりました：',
      attendCleared: 'この端末から設定を消しました。',
      attendNotStored: '✓ つながりました。この画面を開いているあいだは使えます。ただし、この端末には覚えておけない設定のため、開き直したときはもう一度URLとキーを貼ってください。',
      attendModalTitle: '🙋 出欠システムの設定',
      attendModalIntro: '案内文に「出欠を回答する」リンクを付けられます。出欠の回答は、主催者ご自身のGoogleスプレッドシートにだけ保存されます。',
      attendModalStepsTitle: 'まだ用意していない方へ',
      attendModalStepsDesc: 'スプレッドシートのコピーから公開まで、順番に案内します（15分ほど）。',
      attendModalSetupBtn: '出欠システムを用意する ↗',
      attendModalUrlLabel: '🔗 ウェブアプリのURL（…/exec）',
      attendModalKeyLabel: '🔑 書き込みキー',
      attendModalSave: '保存して確認',
      attendModalClose: '閉じる',
      attendModalClear: 'この端末から設定を消す',
      attendModalLinkTitle: '1タップで戻すリンク',
      attendModalLinkDesc: 'この端末が設定を覚えられないときは、このリンクをブックマークしておくと、次からは開くだけで設定が戻ります。',
      attendModalLinkBtn: 'リンクを作ってコピー',
      attendModalLinkCopied: '✓ コピーしました',
      attendModalLinkWarn: '⚠ このリンクには書き込みキーが入っています。ご自分のブックマークに入れるだけにして、人に送らないでください。',
      attendModalLinkNg: '先にURLと書き込みキーを保存してください。',
      attendFromLink: '✓ 出欠システムの設定を戻しました：',
      attendFromLinkNg: 'リンクの設定を戻せませんでした。',
      attendModalFoot: '🔒 URLと書き込みキーはお使いの端末内（ブラウザ）だけに保存されます。書き込みキーは人に見せないでください。',
      annAttend: '出欠を回答する',
    ...
    en: {
      ...
      attendBtn: '🙋 Create attendance',
      attendSetupBtn: '🙋 Add an attendance form',
      attendDone: '✓ Attendance created',
      attendCreating: 'Creating attendance…',
      attendCreated: 'Attendance link added to the announcement',
      attendExisting: 'Using the attendance entry that already existed',
      ...
      attendSettings: 'Attendance settings',
      attendChecking: 'Checking…',
      attendOk: '✓ Connected: ',
      attendCleared: 'Settings removed from this device.',
      attendNotStored: '✓ Connected. You can use it while this page stays open, but this device cannot remember the settings, so you will need to paste the URL and key again next time.',
      attendModalTitle: '🙋 Attendance settings',
      attendModalIntro: 'You can add a "Reply to attendance" link to the announcement. Replies are stored only in your own Google Sheet.',
      attendModalStepsTitle: 'Not set up yet?',
      attendModalStepsDesc: 'We walk you through it, from copying the sheet to publishing (about 15 minutes).',
      attendModalSetupBtn: 'Set up the attendance system ↗',
      attendModalUrlLabel: '🔗 Web app URL (…/exec)',
      attendModalKeyLabel: '🔑 Write key',
      attendModalSave: 'Save and check',
      attendModalClose: 'Close',
      attendModalClear: 'Remove the settings from this device',
      attendModalLinkTitle: 'One-tap restore link',
      attendModalLinkDesc: 'If this device cannot remember the settings, bookmark this link and they will be restored just by opening it.',
      attendModalLinkBtn: 'Create and copy link',
      attendModalLinkCopied: '✓ Copied',
      attendModalLinkWarn: '⚠ This link contains your write key. Keep it in your own bookmarks and do not send it to anyone.',
      attendModalLinkNg: 'Save the URL and write key first.',
      attendFromLink: '✓ Attendance settings restored: ',
      attendFromLinkNg: 'Could not restore the settings from the link.',
      attendModalFoot: '🔒 The URL and write key are stored only on your device (browser). Keep the write key private.',
      annAttend: 'Reply to attendance',
    ...
    "in": {
      ...
      attendBtn: '🙋 Attendance banayein',
      attendSetupBtn: '🙋 Attendance form add karein',
      attendDone: '✓ Attendance ban gaya',
      attendCreating: 'Attendance ban raha hai…',
      attendCreated: 'Announcement mein attendance link add ho gaya',
      attendExisting: 'Jo attendance pehle se tha, wahi use ho raha hai',
      ...
      attendSettings: 'Attendance settings',
      attendChecking: 'Check ho raha hai…',
      attendOk: '✓ Connect ho gaya: ',
      attendCleared: 'Is device se settings hata di gayi hain.',
      attendNotStored: '✓ Connect ho gaya. Jab tak yeh page khula hai tab tak chalega, lekin yeh device settings yaad nahi rakh sakta, isliye agli baar URL aur key dobara paste karni hogi.',
      attendModalTitle: '🙋 Attendance settings',
      attendModalIntro: 'Announcement mein "attendance reply" link add kar sakte hain. Replies sirf aapki apni Google Sheet mein save hote hain.',
      attendModalStepsTitle: 'Abhi tak setup nahi kiya?',
      attendModalStepsDesc: 'Sheet copy karne se publish karne tak, step by step guide (lagbhag 15 minute).',
      attendModalSetupBtn: 'Attendance system setup karein ↗',
      attendModalUrlLabel: '🔗 Web app URL (…/exec)',
      attendModalKeyLabel: '🔑 Write key',
      attendModalSave: 'Save karke check karein',
      attendModalClose: 'Band karein',
      attendModalClear: 'Is device se settings hatayein',
      attendModalLinkTitle: 'One-tap restore link',
      attendModalLinkDesc: 'Agar yeh device settings yaad nahi rakh pata, to is link ko bookmark kar lein - agli baar sirf kholne se settings wapas aa jayengi.',
      attendModalLinkBtn: 'Link banayein aur copy karein',
      attendModalLinkCopied: '✓ Copy ho gaya',
      attendModalLinkWarn: '⚠ Is link mein aapki write key hai. Ise sirf apne bookmarks mein rakhein, kisi ko na bhejein.',
      attendModalLinkNg: 'Pehle URL aur write key save karein.',
      attendFromLink: '✓ Attendance settings wapas aa gayi: ',
      attendFromLinkNg: 'Link se settings wapas nahi la sake.',
      attendModalFoot: '🔒 URL aur write key sirf aapke device (browser) mein save hoti hain. Write key kisi ko na dikhayein.',
      annAttend: 'Attendance reply karein',
