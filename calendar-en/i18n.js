...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      attendNotStored: 'つながりましたが、この端末に保存できませんでした。ブラウザのプライベートブラウズや、Cookie・サイト超えトラッキングのブロック設定をご確認ください。',
    ...
    en: {
      ...
      attendNotStored: 'Connected, but the settings could not be saved on this device. Check your browser settings for private browsing or cookie/tracking blocking.',
    ...
    "in": {
      ...
      attendNotStored: 'Connect ho gaya, lekin is device par settings save nahi hui. Browser ki private browsing ya cookie/tracking blocking settings check karein.',
      attendModalTitle: '🙋 Attendance settings',
