...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      // --- 要チェック（採点係）＆AI ---
      warnNotice: '⚠は「特に注意したい箇所」の目印です。印が無い項目にも誤りがある場合があります。気になる項目はそのまま手で直すか、AIで確認できます。',
    ...
    en: {
      ...
      warnNotice: '⚠ marks the spots most worth double-checking. Items without a mark can still be wrong. Fix anything by hand, or check it with AI.',
    ...
    "in": {
      ...
      warnNotice: '⚠ un jagah par hai jinhe khaas dhyaan se check karna chahiye. Bina mark wale items bhi galat ho sakte hain. Kisi bhi field ko haath se theek karein, ya AI se check karein.',
