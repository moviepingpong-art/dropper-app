...
(function (global) {
  ...
  var I18N = {
    ja: {
      pageTitle: '決めごとドロッパー｜会話のスクショや打ち合わせメモから、決まったこと・未決事項を取り出す',
      appName: '決めごとドロッパー',
      // ツール切り替えタブ
      typePrompt: 'ドロッパーを選ぶ',
      toolEvent: 'イベント',
      toolSchedule: '予定表',
      toolDecide: '決めごと',
      toolHint: '入れるものが違います。チラシ1枚ならイベント、予定表ならN件、会話のスクショや打ち合わせメモなら決めごと。',
      ...
      priv3: '⚠️ 無料枠では、送信内容がGoogleのサービス改善に利用される場合があります（有料枠では利用されません）。他人が写った会話や、名前の入った打ち合わせメモを入れる前にご確認ください。',
      // ドロップ
      dropTitle: '会話のスクショ・打ち合わせメモを入れる',
      dropSub: 'ここにドラッグ、またはタップして選ぶ',
      pickBtn: 'ファイルを選ぶ',
      dropNote: 'チャットのスクリーンショット、手書きのノート、ホワイトボードの写真、FAX（PDFも可）。複数枚をまとめて入れられます（最大10枚）。記録の順に並べてください。上下が重なっていても大丈夫です。',
    ...
    en: {
      pageTitle: 'Decide Dropper | Pull decisions and open questions out of chat screenshots and meeting notes',
      appName: 'Decide Dropper',
      typePrompt: 'Choose a dropper',
      toolEvent: 'Event',
      toolSchedule: 'Schedule',
      toolDecide: 'Decide',
      toolHint: 'Each takes something different. One flyer for Event, a schedule sheet for Schedule, chat screenshots or meeting notes for Decide.',
      ...
      priv3: '⚠️ On the free tier, what you send may be used to improve Google\'s services (the paid tier does not). Please check this before dropping a conversation that involves other people, or notes with names in them.',
      dropTitle: 'Drop your chat screenshots or meeting notes',
      dropSub: 'Drag them here, or tap to choose',
      pickBtn: 'Choose files',
      dropNote: 'Chat screenshots, handwritten notes, a photo of a whiteboard, a fax (PDF is fine). Up to 10 at once. Keep them in order. Overlapping images are fine.',
    ...
    "in": {
      pageTitle: 'Decide Dropper | Chat screenshots aur meeting notes se decisions aur open points nikaalein',
      appName: 'Decide Dropper',
      typePrompt: 'Dropper chunein',
      toolEvent: 'Event',
      toolSchedule: 'Schedule',
      toolDecide: 'Decide',
      toolHint: 'Har ek alag cheez leta hai. Ek flyer ke liye Event, schedule sheet ke liye Schedule, chat screenshots ya meeting notes ke liye Decide.',
      ...
      priv3: '⚠️ Free tier par, jo aap bhejte hain wo Google ki services improve karne mein use ho sakta hai (paid tier par nahi). Dusron ki baatcheet ya naam wale notes daalne se pehle ye dekh lein.',
      dropTitle: 'Chat screenshots ya meeting notes daalein',
      dropSub: 'Yahan drag karein, ya tap karke chunein',
      pickBtn: 'Files chunein',
      dropNote: 'Chat screenshots, handwritten notes, whiteboard ki photo, fax (PDF bhi chalega). Ek baar mein max 10. Order mein rakhein. Overlap ho to bhi theek hai.',
