...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      // --- 「何ができる？」ポップアップ（#what-modal）。★ 申込書ドロッパーのことだけを書く ---
      whatBtn: '🔍 何ができる？',
      whatTitle: '📝 申込書ドロッパー、何ができる？',
      whatLead: '大会の参加申込書（Excel）と名簿を入れると、記入済みにして返します。',
      whatFigRoster: '名簿',
      // ★ 文言は textContent で入る（applyDom）。<br> は書かない。折り返しは CSS に任せる
      whatFigForm: '大会の申込書（Excel）',
      whatFigFilled: '記入済みの申込書',
      whatFigCap: '左の2つを入れると、右が出てきます。',
      whatCanTitle: 'できること',
      whatCan1: '名簿から、氏名・フリガナ・性別・生年月日・年齢・住所・電話番号を書き込みます。',
      whatCan2: '年齢は、申込書に書いてある基準日で計算します。4月2日生まれの1歳のずれも間違えません。',
      whatCan3: '西暦か和暦かは、申込書に指示が無ければ聞きます。勝手に決めません。',
      whatCan4: '罫線も列の幅も印刷の設定も、もらった様式のままです。書いた場所以外は一文字も変えません。',
      whatCan5: 'どの欄に何を書くかは、書く前に一覧で見えます。違っていれば選び直せます。',
      whatCan6: '名簿もこのツールで作れます。競技によって要る項目（所属・学校名・身長など）は足せます。',
      whatSafe: '申込書も名簿も、この端末の中（ブラウザ）だけで扱います。どこにも送りません。AI も使いません。無料で、登録も要りません。',
      whatClose: '閉じる',
