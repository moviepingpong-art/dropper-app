...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      phBirth: '例 19800501',
      phPostal: '例 9230811',
      phAddress: '例 白山市八田町1-2-3',
      formHint: '生年月日は西暦で「19800501」のように。郵便番号はハイフンなしで「9230811」。' +
        '★ 郵便番号を入れると住所が入り、住所（都道府県＋市区町村から）を入れると郵便番号が入ります。',
      ...
      'err.attend-load': '出欠システムに問い合わせられませんでした。通信できていないかもしれません。',
