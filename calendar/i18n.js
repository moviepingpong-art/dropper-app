...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      typeMusic: 'コンサート・発表会・舞台のドロッパー',
      leadMusic: '公演チラシ（PDF・画像）をドロップ → 内容を確認 → Googleカレンダーに登録',
      fldNameMusic: '公演名',
      fldFormatMusic: '演目・プログラム',
      fldOpeningMusic: '開場・開演',
      fldDeadlineMusic: '予約・申込締切',
      typeExhibition: '展示会・個展のドロッパー',
      leadExhibition: '展覧会チラシ（PDF・画像）をドロップ → 内容を確認 → Googleカレンダーに登録',
      fldNameExhibition: '展示名',
      fldFormatExhibition: '展示内容・関連イベント',
      fldOpeningExhibition: '開館時間',
      fldDeadlineExhibition: '出品・応募締切',
      typeLecture: '講演会・セミナー・教室のドロッパー',
      leadLecture: '案内チラシ（PDF・画像）をドロップ → 内容を確認 → Googleカレンダーに登録',
      fldNameLecture: '講演会・講座名',
      fldFormatLecture: '演題・講師',
      fldOpeningLecture: '開始時間',
      fldDeadlineLecture: '申込締切',
      typeFestival: '祭り・地域の催しのドロッパー',
      leadFestival: '催しのチラシ（PDF・画像）をドロップ → 内容を確認 → Googleカレンダーに登録',
      fldNameFestival: '催し名',
      fldFormatFestival: '内容・出し物',
      fldOpeningFestival: '開催時間',
      fldDeadlineFestival: '申込・出店締切',
      typeGeneral: 'その他イベントの案内ドロッパー',
      leadGeneral: '案内チラシ（PDF・画像）をドロップ → 内容を確認 → Googleカレンダーに登録',
    ...
    en: {
      ...
      typeMusic: 'Concert & stage flyer dropper',
      leadMusic: 'Drop a performance flyer (PDF / image) → Review the details → Add to Google Calendar',
      fldNameMusic: 'Performance name',
      fldFormatMusic: 'Programme',
      fldOpeningMusic: 'Doors / Start',
      fldDeadlineMusic: 'Booking deadline',
      typeExhibition: 'Exhibition flyer dropper',
      leadExhibition: 'Drop an exhibition flyer (PDF / image) → Review the details → Add to Google Calendar',
      ...
      typeLecture: 'Lecture & seminar flyer dropper',
      leadLecture: 'Drop a lecture flyer (PDF / image) → Review the details → Add to Google Calendar',
      ...
      typeFestival: 'Festival & community event dropper',
      leadFestival: 'Drop a festival flyer (PDF / image) → Review the details → Add to Google Calendar',
      ...
      typeGeneral: 'Any other event flyer dropper',
      leadGeneral: 'Drop an event flyer (PDF / image) → Review the details → Add to Google Calendar',
    ...
    "in": {
      ...
      typeMusic: 'Concert & stage show flyer dropper',
      leadMusic: 'Show ka flyer (PDF / image) drop karein → Details check karein → Google Calendar mein add karein',
      fldNameMusic: 'Show ka naam',
      fldFormatMusic: 'Programme',
      fldOpeningMusic: 'Doors / Start',
      fldDeadlineMusic: 'Booking deadline',
      typeExhibition: 'Exhibition flyer dropper',
      leadExhibition: 'Exhibition ka flyer (PDF / image) drop karein → Details check karein → Google Calendar mein add karein',
      fldNameExhibition: 'Exhibition ka naam',
      fldFormatExhibition: 'Exhibits / Events',
      fldOpeningExhibition: 'Opening hours',
      fldDeadlineExhibition: 'Submission deadline',
      typeLecture: 'Lecture & seminar flyer dropper',
      leadLecture: 'Lecture ka flyer (PDF / image) drop karein → Details check karein → Google Calendar mein add karein',
      fldNameLecture: 'Lecture / course ka naam',
      fldFormatLecture: 'Topic & speaker',
      fldOpeningLecture: 'Start time',
      fldDeadlineLecture: 'Application deadline',
      typeFestival: 'Mela & community event dropper',
      leadFestival: 'Mela ka flyer (PDF / image) drop karein → Details check karein → Google Calendar mein add karein',
      fldNameFestival: 'Event ka naam',
      fldFormatFestival: 'What is on',
      fldOpeningFestival: 'Opening times',
      fldDeadlineFestival: 'Application deadline',
      typeGeneral: 'Koi bhi event ka flyer dropper',
      leadGeneral: 'Event ka flyer (PDF / image) drop karein → Details check karein → Google Calendar mein add karein',
