...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      annSkipAttend: 'この行事は出欠をとらない → 案内文を作る',
    ...
    en: {
      ...
      annSkipAttend: 'No attendance for this event → write the announcement',
    ...
    "in": {
      ...
      annSkipAttend: 'Is event mein attendance nahi → announcement banayein',
