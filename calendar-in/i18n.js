...
(function (global) {
  ...
  var I18N = {
    ja: {
      ...
      fldDeadline: '申込締切',
      /* 申込締切は**大会主催者へ申し込む期限**。メンバーが答える期限は
         その手前になる（主催者の編成の時間が要るため）。**混ぜないこと。** */
      fldEntryBack: '出欠入力の締切',
      fldEntryBackUnit: '日前',
      entryBackNone: '申込締切が無いので、開催日まで答えられます',
      entryBackUnparsed: '申込締切を日付として読めません。このままだと開催日まで答えられます',
      annAnswerBy: '出欠入力の締切',
      fldNote: 'メモ・備考',
    ...
    en: {
      ...
      fldEntryBack: 'Answers due',
      fldEntryBackUnit: 'days before',
      entryBackNone: 'No entry deadline, so answers stay open until the event',
      entryBackUnparsed: 'The entry deadline is not a readable date, so answers stay open until the event',
      annAnswerBy: 'Answers due by',
      fldNote: 'Notes',
    ...
    "in": {
      ...
      fldDeadline: 'Entry deadline',
      fldEntryBack: 'Jawab ki last date',
      fldEntryBackUnit: 'din pehle',
      entryBackNone: 'Entry deadline nahi hai, isliye event tak jawab de sakte hain',
      entryBackUnparsed: 'Entry deadline date padhi nahi ja rahi, isliye event tak jawab de sakte hain',
      annAnswerBy: 'Jawab ki last date',
      fldNote: 'Notes',
